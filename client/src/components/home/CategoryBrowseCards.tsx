    ...
    <div className="mt-6 sm:mt-12 pt-4 sm:pt-8 border-t border-sky-200 dark:border-sky-800">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-5 gap-2 sm:gap-4 max-w-6xl mx-auto auto-rows-fr">
        ...
        <button
          ...
          className="group relative overflow-hidden rounded-lg sm:rounded-xl bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-950 dark:to-orange-900 border border-orange-200 dark:border-orange-800 p-3 sm:p-6 shadow-md sm:shadow-lg hover:shadow-lg sm:hover:shadow-xl transition-all duration-300 hover:scale-105 hover:border-orange-300 dark:hover:border-orange-700 h-full flex flex-col"
        >
          <div className="absolute inset-0 bg-gradient-to-br from-orange-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
          
          <div className="relative space-y-2 sm:space-y-4">
            <div className="w-10 h-10 sm:w-14 sm:h-14 rounded-lg sm:rounded-xl bg-gradient-to-br from-orange-500 to-orange-600 flex items-center justify-center shadow-md sm:shadow-lg group-hover:shadow-lg sm:group-hover:shadow-xl transition-shadow">
              <Upload className="h-5 w-5 sm:h-7 sm:w-7 text-white" />
            </div>
            
            <div className="text-left">
              <h4 className="text-sm sm:text-lg font-bold text-foreground group-hover:text-orange-700 dark:group-hover:text-orange-400 transition-colors">Bulk Verify</h4>
              <p className="text-xs sm:text-sm text-muted-foreground mt-0.5 sm:mt-1 hidden sm:block">Check multiple codes at once</p>
            </div>
            
            <div className="flex items-center gap-1 sm:gap-2 text-orange-600 dark:text-orange-400 font-semibold text-xs sm:text-sm opacity-0 group-hover:opacity-100 transition-opacity hidden sm:flex">
              Verify <ChevronRight className="h-3 w-3 sm:h-4 sm:w-4" />
            </div>
          </div>
        </button>
        ...
        <button
          ...
          className="group relative overflow-hidden rounded-lg sm:rounded-xl bg-gradient-to-br from-red-50 to-red-100 dark:from-red-950 dark:to-red-900 border border-red-200 dark:border-red-800 p-3 sm:p-6 shadow-md sm:shadow-lg hover:shadow-lg sm:hover:shadow-xl transition-all duration-300 hover:scale-105 hover:border-red-300 dark:hover:border-red-700 h-full flex flex-col"
        >
          <div className="absolute inset-0 bg-gradient-to-br from-red-500/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
          
          <div className="relative space-y-2 sm:space-y-4">
            <div className="w-10 h-10 sm:w-14 sm:h-14 rounded-lg sm:rounded-xl bg-gradient-to-br from-red-500 to-red-600 flex items-center justify-center shadow-md sm:shadow-lg group-hover:shadow-lg sm:group-hover:shadow-xl transition-shadow">
              <Search className="h-5 w-5 sm:h-7 sm:w-7 text-white" />
            </div>
            
            <div className="text-left">
              <h4 className="text-sm sm:text-lg font-bold text-foreground group-hover:text-red-700 dark:group-hover:text-red-400 transition-colors">Non-Covered Codes</h4>
              <p className="text-xs sm:text-sm text-muted-foreground mt-0.5 sm:mt-1 hidden sm:block">Codes not covered by Saudi health insurance</p>
            </div>
            
            <div className="flex items-center gap-1 sm:gap-2 text-red-600 dark:text-red-400 font-semibold text-xs sm:text-sm opacity-0 group-hover:opacity-100 transition-opacity hidden sm:flex">
              Explore <ChevronRight className="h-3 w-3 sm:h-4 sm:w-4" />
            </div>
          </div>
        </button>
