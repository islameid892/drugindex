  ...
  const files: FileItem[] = [
    {
      ...
      url: "/manus-storage/Category_Management_Combined_Guide_c381426a.pdf",
      size: "168 KB",
    ...
    },
    {
      ...
      url: "/manus-storage/Consumer_Centric_Category_Management_Summary(1)_acd808ba.pdf",
      size: "477 KB",
      icon: <FileDown className="h-6 w-6" />,
    },
    {
      ...
      url: "/manus-storage/Consumer_Centric_Category_Management_FINAL_425b5279.pdf",
      size: "198 KB",
      icon: <FileDown className="h-6 w-6" />,
    },
    {
      ...
      url: "/manus-storage/Consumer_Centric_Category_Management_Expanded_English_7f1c4bc2.pdf",
      size: "22 KB",
      icon: <FileDown className="h-6 w-6" />,
    },
  ];
